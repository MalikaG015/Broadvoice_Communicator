...
Feature: Internal chat tests
    ...
    Scenario: Send private message
        ...
        And user selects 'supervisor' chat access
        And user save the settings
        And User login to the platform as 'Agent_1' with 'normal' view with extension '' in 'second' window
    ...
    Scenario: Mark all notifications as read - Broadcast (Particular agent message)
        ...
        Then User login to the platform as 'Agent_1' with 'normal' view with extension '' in 'second' window
    ...
    Scenario: Mark all notifications as read - Break authorization
        ...
        When User login to the platform as 'Agent_1' with 'normal' view with extension '' in 'second' window
    ...
    Scenario: Mark all notifications as read - Suggestion
        ...
        Given User login to the platform as 'Supervisor_1' with 'normal' view with extension '' in 'first' window
        Then clean active calls
        Then user get the counter of message
